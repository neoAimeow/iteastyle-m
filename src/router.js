...
import ProductDisplayUpgrade from '@/components/homepage/productDisplayUpgrade.vue'
...
export default new Router({
  routes: [
    ...
    {
      path: '/homepage/productDisplayUpgrade',
      name: 'productDisplayUpgrade',
      component: ProductDisplayUpgrade
    }
  ]
})